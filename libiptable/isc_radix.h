#pragma once
#ifndef ISC_RADIX_H_INCLUDED
#define ISC_RADIX_H_INCLUDED
/*
...
typedef unsigned isc_refcount_t;
typedef struct {
	unsigned mem_prefix;
	unsigned mem_radix;
} isc_mem_t;
...
#define ISC_MAGIC(_a,_b,_c,_d)	((_a)<<24|(_b)<<16|(_c)<<8|(_d))
#define ISC_MAGIC_VALID(_a,_b)	assert((_a) == (_b))

#define ISC_R_SUCCESS 1
#define ISC_R_NOTFOUND 0
#define ISC_R_NOTIMPLEMENTED -1
...
typedef struct isc_radix_node {
	...
	int		node_num[RADIX_FAMILIES];
		/* which node this was in the tree, or -1 for glue nodes */
} isc_radix_node_t;

#define RADIX_TREE_MAGIC    ISC_MAGIC('R', 'd', 'x', 'T')
#define RADIX_TREE_VALID(a) (RADIX_TREE_MAGIC == (a))
