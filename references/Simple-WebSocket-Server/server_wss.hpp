...
namespace SimpleWeb {
  ...
  protected: /*APY*/
    ...
    SocketServer()
        : SocketServerBase<WSS>(443), context(asio::ssl::context::tlsv12) { //APY
    }
  ...
  protected:
    ...
    void accept(asio::detail::socket_type fd, const asio::ip::tcp &protocol = asio::ip::tcp::v4()) { /*APY*/
      ...
      // assume ownership of the socket descriptor.
      connection->socket->lowest_layer().assign(protocol, fd);
